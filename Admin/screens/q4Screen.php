		...
		<div class="round5 " style="height:<?php echo $total2*13 + 18;?>%;">
			...
			<form  action="../questionRotation.php" method="POST">
				...
				<?php include '../DBconnect.php';
					...
					$result6 = mysqli_query($conn,"select Salary FROM CHEF");
					$row3 = mysqli_fetch_array($result5);

					$total3 = $row3[0];
					$count = 0;
					$sum = 0;
					while($count < $total3 and $row5 = mysqli_fetch_array($result6)){
					...
					$result = mysqli_query($conn, 'SELECT SUM(salary) AS salary FROM chef'); 
...
$strr="";
					...
					echo strrev ( $sum);  ?><br>     <div style="margin-left: 79%;
		
		font-weight: bold;
		color: whitesmoke;
		font-size: 2em;">TL</div></p>
					...
					<div class="bigLine"><p class="text-center" style="font-size:3em">Total Salary</p></div>
