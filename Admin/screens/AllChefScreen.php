		...
		<div class="round">
			...
			<form action="./ChefRsearchScreen.php" method="POST">
					...
					<div class="d-flex flex-row  ">
						<input placeholder="Search..." style="width:17%;height: 15%;margin-top: 0.8%;margin-left: 5%;" type="text" class=" form-control" name="chefsearch">
				...
				<div class="round5" style="height:<?php echo $total*13 + 18;?>%;">
					<form  action="./ChefRegistrationScreen.php" method="POST">
						<p style="color:black;background-color: skyblue;">Total Chef Number: <?php echo $total;?></p>
					</form>
