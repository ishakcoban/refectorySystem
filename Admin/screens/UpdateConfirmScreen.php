...
<form action="./AdminHomePageScreen.php" method="POST">
					<button style="margin-left:5%" class=" btn btn-success bttt mt-2" type="submit" name="banr" >Go to HOME PAGE</button></form>
			
				<nav>

					<a href="./MyAccountAdminScreen.php">My Account</a>
					<a href="./StatsScreen.php">My Stats</a>
			...
			<div class="round1">
					...
					<p class="sign" >Your information was updates successfully.</p>
					<p class="sign" >You can check it on <b>My Account</b>.</p>
