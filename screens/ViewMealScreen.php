	...
	<div class="section">
		...
		<div class="round">
			...
			<form  class="d-flex flex-row" action="../MyReservationRotateValidation.php" method="POST">
				...
				<form method="POST" action="./homeMealSearchScreen.php" style="margin-top: -2.5%;">
					<input class="bg-light text-center " style="width: 20%;border-radius:25px;color: black;margin-left: 45%;" type="text" name="refm" placeholder="Search"></form>
					...
					<form action="../DeleteValid.php" method="POST">
						...
						while ($count < $total AND $row1 = mysqli_fetch_array($result1)) {
							...
							<div class="d-flex flex-row" style="background-color: black;">
								...
								<p style="color:skyblue;margin-left: 15.5%;"><?php echo $row1['MEAL_ID']  ?></p>
								<p style="color:skyblue;margin-left: 22%;"><?php echo $row1['MEAL_NAME']  ?></p>
