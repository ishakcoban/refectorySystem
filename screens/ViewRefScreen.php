	...
	<div class="section">
		...
		<div class="round">
			...
			<form  class="d-flex flex-row" action="../MyReservationRotateValidation.php" method="POST">
				<button style="margin-left:5%;background-color:green;color: white;z-index: 1;" class=" btn  bttt mt-2" type="submit" name="homr" >Go to <b>HOME</b> Page</button>

				<button style="margin-left:1%;background-color:#0275d8;color: white;z-index: 1;" class=" btn bttt mt-2" type="submit" name="banrrr" >Books A New Reservation</button></form>

				<form method="POST" action="./homeRefSearchScreen.php" style="margin-top: -2.5%;">
					<input class="bg-light text-center " style="width: 20%;border-radius:25px;color: black;margin-left: 45%;" type="text" name="refs" placeholder="Search"></form>
				...
				<div class="round5" style="height:5%;">
					...
					<form action="../DeleteValid.php" method="POST">
						...
						<div class="d-flex flex-row "><p style="color: skyblue; margin-left: 15%;" ><b>REFECTORY ID</b></p>
							<p style="color: skyblue; margin-left:23%" ><b>NAME</b></p>
							<p style="color: skyblue; margin-left: 24%" ><b>ADDRESS</b></p>
						...
						$total = $row[0];
						$id = $_SESSION['id'];
						$result1 = mysqli_query($conn,"select REF_ID,NAME,ADDRESS FROM refectory");
						...
						while ($count < $total AND $row1 = mysqli_fetch_array($result1)) {
							...
							<div class="d-flex flex-row" style="background-color: black;">
								...
								<p style="color:skyblue;margin-left: 17%;"><?php echo $row1['REF_ID']  ?></p>
								<p style="color:skyblue;margin-left: 26.6%;"><?php echo $row1['NAME']  ?></p>




							</div>
							<p style="color:skyblue;margin-top: -3.5%;margin-left: 76.5%;"><?php echo $row1['ADDRESS']  ?></p>
							<br>
							<?php
							$count++;
						}
