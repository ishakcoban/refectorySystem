      			...
      			<div class="d-flex flex-row"><img  src="../images/update1.png"   >
      				...
      				<form  action="../UpdateValidation.php" method="POST">
      					<div class="d-flex flex-column inputs text-center ">
      						<input class="form-control text-center" required name="NN" placeholder="NAME" type=" text" />
      						...
      						<button class="btnn btn btn-primary mt-5" type="submit" name="update">Confirm</button>
