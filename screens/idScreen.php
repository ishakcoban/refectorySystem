		...
		<div class="round" method="POST">
			...
			<form  action="./HomePageScreen.php" method="POST">
				...
				<div class="d-flex flex-column inputs text-center ">
					...
					<p class="yourid text-primary" ><?php session_start(); echo $_SESSION['id'];  ?> </p>
					<p class="cong" >Congratulations!</p>
					<p class="sign" >You have been signed up.</p>
					<p class="descp" >The thing shown above is your <b>ID</b> to sign in on our system.<br>Don't forget your <b>ID</b>.<br> Also, you can access this on <b>My Account</b> page. </p>

					<button class="btnn btn btn-primary " type="submit" name="insert">Go to <b>HOME</b> Page</button>
